        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firstName.length() == 0 || lastName.length() == 0 || phoneNumber.length() == 0) {
                    Toast.makeText(AddContactActivity.this, "Please make sure all details are correct", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                try {
                    ...
                    Toast.makeText(AddContactActivity.this, "A contact with same phone number already exists.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
